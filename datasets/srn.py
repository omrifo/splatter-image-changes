...
SHAPENET_DATASET_ROOT = "/content/drive/MyDrive/Colab_Notebooks/computer_vision_project/dataset" # Change this to your data directory
...
class SRNDataset(SharedDataset):
    ...
    def __getitem__(self, index):
        ...
        images_and_camera_poses = {
            ...
            "depth_images":self.all_depths[example_id][frame_idxs].clone(),
